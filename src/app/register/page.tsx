...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f8fafc] px-4 selection:bg-emerald-100 selection:text-emerald-900">
      <Toaster />
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-3xl shadow-xl border border-emerald-50 relative overflow-hidden">
        {/* Decorative background blur */}
        <div className="absolute top-0 left-0 w-full h-32 bg-gradient-to-br from-emerald-100 to-teal-50 opacity-50 -z-10 transform skew-y-6 origin-top-right"></div>
          ...
          <div className="space-y-4 rounded-md shadow-sm">
            <div>
              ...
              <input
                ...
                type="text"
                required
                className="appearance-none relative block w-full px-4 py-3 border border-gray-200 placeholder-gray-400 text-gray-900 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 focus:z-10 sm:text-sm transition-all duration-200 ease-in-out"
